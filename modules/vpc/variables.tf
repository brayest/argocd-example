...
variable "s3_endping_route_tables" {
  description = "List of route tables ID for the subnetes to incorporate to the S3 endpoint"
  type        = list(string)
  default     = []
}
...
variable "custom_subnets" {
  description = "Additional subnets definitions"
  type        = any
  default     = {}
}
